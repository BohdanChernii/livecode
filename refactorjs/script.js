...
//good
//const withdraw = (clients, balances, client, amount) => balances[clients.indexOf(client)] < amount ? -1 : balances[clients.indexOf(client)] -= amount;
...
//good
function withdraw(clients, balances, client, amount) {
  const clientIndex = client.indexOf(client);
...
const clients = ["Denis", "Andey", "Jack"];
